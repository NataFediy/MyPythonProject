...
# Some students have subscribed to English only, some have subscribed to French
# only, and some have subscribed to both newspapers.
...
#
# Output Format:
# Output total number of students who have subscriptions to
...
# 8
# Explanation:
# The roll numbers of students who have subscriptions to English or
# French newspapers but not both are:
...
print(len(n_en.symmetric_difference(b_fr)))