...
# Output Format:
#
# Output the total number of students who are subscribed to
# the English newspaper only.
#
# Sample Input:
# 9
# 1 2 3 4 5 6 7 8 9
...
# 4
# Explanation:
# The roll numbers of students who only have English newspaper
# subscriptions are:
# 4, 5, 7 and 9.
...
print(len(n_en.difference(b_fr)))