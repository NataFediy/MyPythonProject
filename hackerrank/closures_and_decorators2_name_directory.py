...
# Print their names in a specific format sorted by their age in ascending
# order i.e. the youngest person's name should be printed first.
...
#
# Output Format:
# Output  names on separate lines in the format described above in ascending
# order of age.
#
# Sample Input:
# 3
...
# You can read more about it https://goo.gl/MW5nXb.
