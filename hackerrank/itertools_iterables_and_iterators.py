...
# For a given integer K, you can select any K indices (assume 1-based
...
#
# Output Format:
# Output a single line consisting of the probability that at least one
# of the K indices selected contains the letter:'a'.
#
...
#
# Explanation:
# All possible unordered tuples of length 2 comprising of indices
# from 1 to 4 are:
# (1,2),(1,3),(1,4),(2,3),(2,4),(3,4)
# Out of these 6 combinations, 5 of them contain either index 1 or 2 index
...
arr = input().split()
k = int(input())
array_comb = list(itertools.combinations(arr, k))
array = list(filter(lambda item: 'a' in item, array_comb))
prob = len(array)/len(array_comb)
print('%.3f' % prob)
