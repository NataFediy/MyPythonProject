...
# and you have to print its score. The score is calculated by the sum
# of the score of each element. For any element, the score is equal to
...
# NOTE:
# In order to parse and generate an XML element tree, use the following
# code:
