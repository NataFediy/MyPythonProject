...
# regex_integer_in_range and regex_alternating_repetitive_digit_pair.
#
# Where:
# regex_integer_in_range should match only integers range from 100000 to 999999
#           inclusive
...
# to check if the input string P is a valid postal code using the following
# expression:
#
...
P = input()
if int(P) < 100000 or int(P) > 999999:
    print('Invalid')
else:
